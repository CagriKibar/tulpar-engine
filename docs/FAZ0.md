...
> Plan: `PLAN.md` §7 Faz 0. Kapatıldı 2026-09-14. Kod: bu deponun kökü (L0 `platform/`, L1 `core/`), testler `tests/`.
> Çalıştırma: `cmake -S . -B yapi -G Ninja -DCMAKE_BUILD_TYPE=Release && cmake --build yapi -j && ./yapi/engine_tests` (CI: Linux x86_64 + Windows MSYS2).
