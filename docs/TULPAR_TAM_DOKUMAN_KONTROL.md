...
| 9 | 🟠 Faz numaralandırması "Faz 5 = Simülasyon" | Proje 2026-09-14'te yeniden numaralandırdı: **yeni Faz 2 = Simülasyon** (kapandı), **yeni Faz 5 = Temporal** (henüz başlamadı) | `PLAN.md:460`, `docs/FAZ2.md` başlığı |
