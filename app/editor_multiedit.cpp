...
const Leaf kLeaves[] = {
    ...
    {offsetof(SceneEntity, particle_curl_strength), sizeof(float), "particle_curl_strength"},
    {offsetof(SceneEntity, particle_curl_freq), sizeof(float), "particle_curl_freq"},
    {offsetof(SceneEntity, particle_drag), sizeof(float), "particle_drag"},
    {offsetof(SceneEntity, particle_collision), sizeof(bool), "particle_collision"},
    {offsetof(SceneEntity, particle_bounce), sizeof(float), "particle_bounce"},
    {offsetof(SceneEntity, particle_sub_on_death), sizeof(uint32_t), "particle_sub_on_death"},
    {offsetof(SceneEntity, particle_ribbon), sizeof(bool), "particle_ribbon"},
